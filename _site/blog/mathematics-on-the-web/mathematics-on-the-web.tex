...
below.
\end{abstract}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, sharp corners, enhanced, breakable, frame hidden, boxrule=0pt, interior hidden]}{\end{tcolorbox}}\fi
...
(\textcite{hata2022github}) which enable attempts to create more
efficient projects.

\begin{quote}
GitHub is a revolutionary resource that has profoundly impacted the
development world and remains an invaluable asset. I express my deep
