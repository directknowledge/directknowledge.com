...
discussed.
\end{abstract}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, enhanced, interior hidden, frame hidden, breakable, sharp corners, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi

\hypertarget{how-is-the-preface-of-a-mathematics-book-different-from-others}{%
\subsection{How Is the Preface of a Mathematics Book Different From
Others}\label{how-is-the-preface-of-a-mathematics-book-different-from-others}}

\hypertarget{who-is-the-preface-written-for}{%
\subsection{Who Is the Preface Written
For}\label{who-is-the-preface-written-for}}

\hypertarget{what-should-go-into-a-preface}{%
\subsection{What Should Go Into A
Preface}\label{what-should-go-into-a-preface}}

\hypertarget{what-should-not-go-into-a-preface}{%
\subsection{What Should Not Go Into A
Preface}\label{what-should-not-go-into-a-preface}}

\hypertarget{the-preface-of-a-newer-edition}{%
\subsection{The Preface Of A Newer
Edition}\label{the-preface-of-a-newer-edition}}
