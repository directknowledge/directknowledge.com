...
\begin{figure}[h]
\begin{center}
{\includegraphics[width= 170pt]{_includes/concavity-and-curve-sketching-7.pdf}}
\caption{$f(x)=3x^{3/5}\left(5-x-4x^2\right)$}
\label{fig:graph17}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
{\includegraphics[width= 170pt]{_includes/concavity-and-curve-sketching-8.pdf}}
\caption{$f(x)=x^{2/3}\left(x^2+5x-20\right)$}
\label{fig:graph18}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
{\includegraphics[width= 170pt]{_includes/concavity-and-curve-sketching-30.pdf}}
\caption{$f(x)=x^{2/3} (x - 1)^{1/3}$}
\label{fig:graph19}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
{\includegraphics[width= 170pt]{_includes/concavity-and-curve-sketching-9.pdf}}
\caption{$\ds f(x)=\frac{2x^2}{x^2-1}$}
\label{fig:graph20}
\end{center}
\end{figure}
...
=+\infty  & \ds \lim _{x\to 1^-}\frac{2x^2}{x^2-1}
=-\infty  \\[10pt]
\ds 
\lim _{x\to -1^+}\frac{2x^2}{x^2-1}
=-\infty  & \ds \lim _{x\to -1^-}\frac{2x^2}{x^2-1}
...
\begin{figure}[h]
\begin{center}
{\includegraphics[width= 170pt]{_includes/concavity-and-curve-sketching-10.pdf}}
\caption{$f(x)=2 \cos  x+\sin  2 x$}
\label{fig:graph21}
\end{center}
\end{figure}
