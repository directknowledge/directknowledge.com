...
\item $  y=(x-1)\left(x^2+x+1\right).$
\item $  y=\frac{2x+5}{3x-2}.$
\item $  f(t)=\frac{t^2-1}{t^2+t-2}.$
...
\item $  u=\frac{\left(x^2+x\right)\left(x^2-x+1\right)}{x^4}.$
\item $  p=\frac{q^2+3}{(q-1)^3+(q+1)^3}.$
\item $  w=\frac{3z^2e^z}{z+1}.$
...
\item $y=\left(x^4+3x^2+17x+82\right)^3$ 
\item $y=\frac{x^4+3x^2+17x+82}{\sqrt{x}}$
