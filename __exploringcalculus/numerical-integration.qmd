...
The first formula is called the \index{left rule} and the second formula the \index{right rule} **left rule} and the second formula the \index{right rule** .
::: 
...
\begin{figure}[h]
\begin{center}
\subfigure[Using left endpoints.]{
\includegraphics[width= 150pt]{_includes/1.pdf}
\label{fig:subfig1}
}
\subfigure[Using right endpoints.]{
\includegraphics[width= 150pt]{_includes/2.pdf}
\label{fig:subfig2}
}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\subfigure[Using midpoints.]{
\includegraphics[width= 150pt]{_includes/3.pdf}
\label{fig:subfig3}
}
\subfigure[Using trapezoids.]{
\includegraphics[width= 150pt]{_includes/4.pdf}
\label{fig:subfig4}
}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
{\includegraphics[width= 200pt]{_includes/5.pdf}}
\caption{Using trapezoids.}
\label{fig:graph5}
\end{center}
\end{figure}
...
\begin{center}
\subfigure[Using trapezoids.]{
\includegraphics[width= 150pt]{_includes/6.pdf}
\label{fig:subfig6}
}
\subfigure[Using parabolic arcs.]{
\includegraphics[width= 150pt]{_includes/7.pdf}
\label{fig:subfig7}
}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
{\includegraphics[width= 200pt]{_includes/8.pdf}}
\caption{Using Simpson Rule.}
\label{fig:graph8}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
{\includegraphics[width= 200pt]{_includes/9.pdf}}
\caption{Determining the error with Simpson Rule.}
\label{fig:graph9}
\end{center}
\end{figure}
