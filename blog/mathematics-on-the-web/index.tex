...
below.
\end{abstract}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, interior hidden, enhanced, frame hidden, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
